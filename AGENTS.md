...
## Key Files Every Agent Must Read at Session Start

1. AGENTS.md (this file)
2. docs/open-decisions.md — check for OPEN decisions before starting any task
3. changelog/ — read the latest session summary file to know current state

Never start a task without checking docs/open-decisions.md first.
If you encounter a new ambiguity, add it to docs/open-decisions.md — do NOT silently resolve it.
